...
def determine_psm(image):
    ...
    print(f"  [Layout Analysis] Height: {height}px, Aspect Ratio: {aspect_ratio:.2f}")
    print(f"  [Layout Analysis] Line peaks: {line_peaks}, Pixel Density: {pixel_density:.2f}%")
